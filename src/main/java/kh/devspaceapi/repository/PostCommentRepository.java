...
public interface PostCommentRepository extends JpaRepository<PostComment, Long> {
	...
	Page<PostComment> findPostsByTargetIdAndTargetTypeAndActiveTrue(Long targetId, TargetType targetType, Pageable pageable);

	Page<PostComment> findCommentsByTargetIdAndTargetTypeAndActiveTrue(Long newsPostId, TargetType news, Pageable pageable);
}
